...
|---|---|---|---|---|
| [abap](#abap) | 3 | 3 | 2 | #2535 |
| [ada](#ada) | 2 | 3 | 4 | #2535 #2546 |
| [agc_assembly](#agc_assembly) | 5 | 3 | 3 | #2535 |
| [apex](#apex) | 7 | 5 | 6 | #2535 #2545 #2546 |
| [assembly](#assembly) | 2 | 2 | 5 | #2535 #2546 |
| [c](#c) | 4 | 2 | 4 | #2535 #2546 |
| [cobol](#cobol) | 5 | 7 | 5 | #2535 #2537 #2538 |
| [cpp](#cpp) | 0 | 2 | 3 | #2535 #2546 |
| [csharp](#csharp) | 0 | 2 | 3 | #2535 #2546 |
| [dart](#dart) | 1 | 1 | 4 | #2535 |
| [dockerfile](#dockerfile) | 5 | 11 | 5 | #2535 #2546 #2547 |
| [embedded_python](#embedded_python) | 5 | 5 | 4 | #2535 |
| [fortran](#fortran) | 5 | 4 | 5 | #2535 #2540 #2546 |
| [go](#go) | 3 | 0 | 5 | #2535 #2542 #2546 |
| [groovy](#groovy) | 1 | 3 | 4 | #2535 |
| [haskell](#haskell) | 6 | 5 | 4 | #2535 |
| [java](#java) | 1 | 2 | 3 | #2535 #2546 |
| [javascript](#javascript) | 1 | 5 | 4 | #2535 #2539 |
| [kotlin](#kotlin) | 2 | 1 | 5 | #2535 #2545 #2546 |
| [livecode](#livecode) | 4 | 5 | 5 | #2535 #2546 #2547 |
| [lua](#lua) | 3 | 3 | 3 | #2535 #2546 |
| [m4](#m4) | 8 | 6 | 4 | #2535 |
| [makefile](#makefile) | 3 | 5 | 4 | #2535 #2546 |
| [matlab](#matlab) | 5 | 3 | 5 | #2535 #2546 #2547 |
| [objective-c](#objective-c) | 3 | 1 | 6 | #2535 #2545 #2546 |
| [perl](#perl) | 3 | 7 | 5 | #2535 #2546 |
| [php](#php) | 2 | 1 | 4 | #2535 #2541 #2546 |
| [powershell](#powershell) | 4 | 4 | 6 | #2535 #2545 #2546 #2547 |
| [python](#python) | 5 | 3 | 5 | #2535 #2536 |
| [ruby](#ruby) | 0 | 2 | 3 | #2535 #2546 |
| [rust](#rust) | 0 | 0 | 2 | #2535 |
| [scala](#scala) | 2 | 2 | 3 | #2535 |
| [scheme](#scheme) | 5 | 3 | 5 | #2535 #2537 |
| [shell](#shell) | 1 | 5 | 5 | #2535 #2547 |
| [sqlite](#sqlite) | 8 | 2 | 4 | #2535 #2547 |
| [swift](#swift) | 5 | 0 | 4 | #2535 #2543 #2546 |
| [tcl](#tcl) | 2 | 3 | 4 | #2535 #2546 |
| [typescript](#typescript) | 1 | 0 | 4 | #2535 #2546 |
| [zig](#zig) | 4 | 2 | 5 | #2535 #2545 |
...
- 🔴 `risk_cognitive_load`: 7.0764 vs median 16.7918 (-58%)
- 🔴 `state_mutation`: 2 vs median 6 (-67%)
- 🟡 `branch`: 3 vs median 5 (-40%)
- 🟡 `keyword_hits`: 162 vs median 256 (-37%)
...
- 🔴 `risk_api_exposure`: 0 vs median 5.33472 (-100%)
- 🟡 `keyword_hits`: 176 vs median 256 (-31%)
- 🟡 `risk_cognitive_load`: 24.2458 vs median 16.7918 (+44%)
...
- 🔴 `doc`: 2 vs median 1 (+100%)
- 🔴 `risk_api_exposure`: 1.88742 vs median 5.33472 (-65%)
- 🔴 `risk_cognitive_load`: 4 vs median 16.7918 (-76%)
- 🔴 `state_mutation`: 2 vs median 6 (-67%)
- 🟡 `comment_lines`: 21 vs median 30 (-30%)
- 🟡 `risk_spec_match`: 65.3333 vs median 96 (-32%)
- 🟡 `risk_verification`: 1.72414 vs median 2.368 (-27%)
...
- 🔴 `doc`: 2 vs median 1 (+100%)
- 🔴 `risk_api_exposure`: 0 vs median 5.33472 (-100%)
- 🔴 `risk_cognitive_load`: 30.2902 vs median 16.7918 (+80%)
- 🔴 `risk_state_flux`: 39.9925 vs median 20 (+100%)
- 🔴 `risk_tech_debt`: 79.97 vs median 39.9576 (+100%)
- 🟡 `args`: 18 vs median 13 (+38%)
- 🟡 `risk_safety_score`: 54.7071 vs median 37.3909 (+46%)
- 🟡 `safety`: 3 vs median 2 (+50%)
...
- 🔴 `risk_cognitive_load`: 32.9884 vs median 16.7918 (+96%)
- 🟡 `io`: 4 vs median 3 (+33%)
- 🟡 `risk_documentation`: 73.1353 vs median 58.3705 (+25%)
...
- 🔴 `io`: 5 vs median 3 (+67%)
- 🔴 `risk_api_exposure`: 11.5689 vs median 5.33472 (+117%)
- 🔴 `risk_state_flux`: 38.7639 vs median 20 (+94%)
- 🔴 `state_mutation`: 11 vs median 6 (+83%)
- 🟡 `risk_documentation`: 79.9696 vs median 58.3705 (+37%)
...
- 🔴 `risk_cognitive_load`: 8.11636 vs median 16.7918 (-52%)
- 🔴 `state_mutation`: 2 vs median 6 (-67%)
- 🟡 `comment_lines`: 15 vs median 30 (-50%)
- 🟡 `globals`: 3 vs median 2 (+50%)
- 🟡 `high_risk_execution`: 3 vs median 2 (+50%)
- 🟡 `io`: 4 vs median 3 (+33%)
- 🟡 `keyword_hits`: 178 vs median 256 (-30%)
- 🟡 `risk_api_exposure`: 6.81696 vs median 5.33472 (+28%)
- 🟡 `risk_safety_score`: 53.1215 vs median 37.3909 (+42%)
...
- **c.cpy** · `77 HACK-LEVEL PIC 9. / DISPLAY HACK-LEVEL.` (code): COUNTED (+2): hyphen is a word boundary so \bHACK\b matches inside the identifier, both occurrences; the PROBE-TODO paragraph name likewise adds planned_debt +1. Ledger: cobol-hyphen-identifier-debt-leak; gitgalaxy#2537
...
- 🔴 `risk_api_exposure`: 1.0506 vs median 5.33472 (-80%)
- 🔴 `risk_cognitive_load`: 4 vs median 16.7918 (-76%)
- 🔴 `risk_state_flux`: 39.9982 vs median 20 (+100%)
- 🟡 `dependency_links`: 4 vs median 3 (+33%)
- 🟡 `func_start`: 17 vs median 13 (+31%)
- 🟡 `functions_found`: 17 vs median 13 (+31%)
- 🟡 `high_risk_execution`: 3 vs median 2 (+50%)
- 🟡 `import`: 4 vs median 3 (+33%)
- 🟡 `keyword_hits`: 185 vs median 256 (-28%)
- 🟡 `risk_documentation`: 38.1027 vs median 58.3705 (-35%)
- 🟡 `risk_safety_score`: 55.625 vs median 37.3909 (+49%)
- 🟡 `risk_spec_match`: 61.3333 vs median 96 (-36%)
- 🟡 `risk_verification`: 1.70158 vs median 2.368 (-28%)
...
- 🟡 `comment_lines`: 45 vs median 30 (+50%)
- 🟡 `io`: 4 vs median 3 (+33%)
- 🟡 `risk_documentation`: 73.8245 vs median 58.3705 (+26%)
- 🟡 `risk_tech_debt`: 20 vs median 39.9576 (-50%)
- 🟡 `test`: 3 vs median 2 (+50%)
...
|---|---|---|---|---|
| `census-requires-git-tracked` | engine-semantic | — | — | GalaxyScope's census enumerates git-tracked files only; an untracked folder scans as '0 files mapped' with no per-file warning |
| `embedded-python-per-file-classification` | engine-semantic | — | — | Classification is per-file with no folder-context bleed: a .py file without its own micropython marker (import machine etc.) classifies as plain python even when every s… |
| `batch4-dual-keyword-overlaps` | keyword-overlap | — | — | Collective entry for batch 4's finditer-confirmed dual-rule keywords, each detailed in its language's manifest notes: agc RESUME (cleanup+branch), livecode global (globa… |
| `string-literal-selective-shielding` | upstream-question | [#2535](https://github.com/squid-protocol/gitgalaxy/issues/2535) | — | Keywords inside one string literal ('if eval fails, try open') count toward branch (+2), safety (+1), io (+1) but eval does NOT count toward high_risk_execution (routes … |
...
- 🔴 `doc`: 2 vs median 1 (+100%)
- 🔴 `risk_api_exposure`: 9.73064 vs median 5.33472 (+82%)
- 🔴 `risk_cognitive_load`: 6.37874 vs median 16.7918 (-62%)
- 🔴 `risk_safety_score`: 70.1726 vs median 37.3909 (+88%)
- 🔴 `risk_state_flux`: 37.3978 vs median 20 (+87%)
- 🟡 `high_risk_execution`: 3 vs median 2 (+50%)
- 🟡 `io`: 4 vs median 3 (+33%)
- 🟡 `risk_documentation`: 75.9927 vs median 58.3705 (+30%)
- 🟡 `safety_bypasses`: 3 vs median 2 (+50%)
...
- **b.f90** · `NOTE = 'IF GOTO FAILS TRY OPEN AGAIN'` (string): COUNTED like cobol: IF+GOTO (branch +2), GOTO (high_risk +1), OPEN (io +1); TRY inert (not a fortran keyword). Also triggers the flux weighting on this file's 2 assignments (state 2 -> 6). Ledger: string-literal-selective-shielding, state-flux-branch-weighting
...
- 🔴 `risk_api_exposure`: 1.89168 vs median 5.33472 (-65%)
- 🔴 `safety_bypasses`: 5 vs median 2 (+150%)
- 🔴 `state_mutation`: 11 vs median 6 (+83%)
...
- 🟡 `risk_cognitive_load`: 23.2925 vs median 16.7918 (+39%)
- 🟡 `safety`: 3 vs median 2 (+50%)
...
- 🔴 `risk_api_exposure`: 0 vs median 5.33472 (-100%)
- 🔴 `risk_cognitive_load`: 5.53524 vs median 16.7918 (-67%)
- 🔴 `risk_safety_score`: 56.3515 vs median 37.3909 (+51%)
- 🔴 `risk_state_flux`: 39.8873 vs median 20 (+99%)
- 🔴 `safety`: 4 vs median 2 (+100%)
- 🔴 `safety_bypasses`: 4 vs median 2 (+100%)
- 🟡 `keyword_hits`: 146 vs median 256 (-43%)
- 🟡 `risk_documentation`: 43.1253 vs median 58.3705 (-26%)
- 🟡 `risk_spec_match`: 65.3333 vs median 96 (-32%)
- 🟡 `risk_tech_debt`: 20 vs median 39.9576 (-50%)
...
- 🔴 `doc`: 2 vs median 1 (+100%)
- 🟡 `risk_cognitive_load`: 22.4845 vs median 16.7918 (+34%)
- 🟡 `safety`: 3 vs median 2 (+50%)
...
- 🟡 `io`: 4 vs median 3 (+33%)
- 🟡 `risk_cognitive_load`: 8.40777 vs median 16.7918 (-50%)
- 🟡 `risk_state_flux`: 13.551 vs median 20 (-32%)
- 🟡 `safety`: 3 vs median 2 (+50%)
...
- 🔴 `branch`: 19 vs median 5 (+280%)
- 🔴 `doc`: 2 vs median 1 (+100%)
- 🟡 `risk_cognitive_load`: 22.1062 vs median 16.7918 (+32%)
...
- 🔴 `doc`: 2 vs median 1 (+100%)
- 🔴 `risk_api_exposure`: 8.00434 vs median 5.33472 (+50%)
- 🔴 `risk_cognitive_load`: 6.298 vs median 16.7918 (-62%)
- 🔴 `safety_bypasses`: 4 vs median 2 (+100%)
- 🟡 `branch`: 7 vs median 5 (+40%)
- 🟡 `risk_documentation`: 73.1335 vs median 58.3705 (+25%)
- 🟡 `risk_safety_score`: 54.3674 vs median 37.3909 (+45%)
- 🟡 `safety`: 3 vs median 2 (+50%)
- 🟡 `state_mutation`: 9 vs median 6 (+50%)
...
- 🔴 `risk_api_exposure`: 11.366 vs median 5.33472 (+113%)
- 🔴 `risk_safety_score`: 69.7879 vs median 37.3909 (+87%)
- 🔴 `safety_bypasses`: 4 vs median 2 (+100%)
- 🟡 `io`: 4 vs median 3 (+33%)
- 🟡 `risk_cognitive_load`: 24.8604 vs median 16.7918 (+48%)
- 🟡 `risk_documentation`: 77.7796 vs median 58.3705 (+33%)
...
- 🔴 `risk_api_exposure`: 0 vs median 5.33472 (-100%)
- 🔴 `risk_cognitive_load`: 4 vs median 16.7918 (-76%)
- 🔴 `risk_documentation`: 22.9356 vs median 58.3705 (-61%)
- 🔴 `risk_safety_score`: 57.4043 vs median 37.3909 (+54%)
- 🔴 `risk_spec_match`: 41.3333 vs median 96 (-57%)
- 🔴 `risk_state_flux`: 40 vs median 20 (+100%)
- 🔴 `risk_tech_debt`: 80 vs median 39.9576 (+100%)
- 🟡 `args`: 18 vs median 13 (+38%)
- 🟡 `branch`: 3 vs median 5 (-40%)
- 🟡 `comment_lines`: 21 vs median 30 (-30%)
- 🟡 `keyword_hits`: 174 vs median 256 (-32%)
- 🟡 `risk_verification`: 1.28776 vs median 2.368 (-46%)
...
- 🔴 `args`: 1 vs median 13 (-92%)
- 🔴 `functions_found`: 0 vs median 13 (-100%)
- 🔴 `risk_api_exposure`: 0.95924 vs median 5.33472 (-82%)
- 🟡 `cleanup`: 3 vs median 2 (+50%)
- 🟡 `io`: 4 vs median 3 (+33%)
- 🟡 `keyword_hits`: 186 vs median 256 (-27%)
- 🟡 `risk_cognitive_load`: 10.0272 vs median 16.7918 (-40%)
- 🟡 `risk_tech_debt`: 20 vs median 39.9576 (-50%)
...
- 🔴 `risk_cognitive_load`: 43.8165 vs median 16.7918 (+161%)
- 🔴 `risk_safety_score`: 71.3187 vs median 37.3909 (+91%)
- 🔴 `risk_state_flux`: 79.9098 vs median 20 (+300%)
...
- 🔴 `risk_cognitive_load`: 29.0086 vs median 16.7918 (+73%)
- 🟡 `state_mutation`: 9 vs median 6 (+50%)
...
- 🔴 `risk_api_exposure`: 2.4136 vs median 5.33472 (-55%)
- 🔴 `risk_state_flux`: 34.5299 vs median 20 (+73%)
- 🔴 `state_mutation`: 10 vs median 6 (+67%)
- 🟡 `functions_found`: 9 vs median 13 (-31%)
- 🟡 `io`: 4 vs median 3 (+33%)
- 🟡 `risk_cognitive_load`: 23.0172 vs median 16.7918 (+37%)
- 🟡 `risk_safety_score`: 53.5487 vs median 37.3909 (+43%)
- 🟡 `risk_tech_debt`: 20 vs median 39.9576 (-50%)
- 🟡 `safety`: 3 vs median 2 (+50%)
- 🟡 `test`: 3 vs median 2 (+50%)
...
- 🔴 `risk_api_exposure`: 9.63854 vs median 5.33472 (+81%)
- 🔴 `risk_cognitive_load`: 30.1398 vs median 16.7918 (+79%)
- 🔴 `risk_state_flux`: 34.5299 vs median 20 (+73%)
- 🟡 `io`: 4 vs median 3 (+33%)
- 🟡 `risk_documentation`: 81.6549 vs median 58.3705 (+40%)
- 🟡 `risk_safety_score`: 53.2735 vs median 37.3909 (+42%)
- 🟡 `safety`: 3 vs median 2 (+50%)
...
- 🔴 `doc`: 2 vs median 1 (+100%)
- 🔴 `io`: 6 vs median 3 (+100%)
- 🔴 `risk_cognitive_load`: 4.821 vs median 16.7918 (-71%)
- 🔴 `state_mutation`: 2 vs median 6 (-67%)
- 🟡 `risk_api_exposure`: 7.35003 vs median 5.33472 (+38%)
- 🟡 `safety`: 3 vs median 2 (+50%)
- 🟡 `test`: 3 vs median 2 (+50%)
...
- **a.py** · `MESSAGE = "if eval fails, try open"` (string): PARTIAL: if/try/open COUNT from inside the literal (branch +2, safety +1, io +1, baked into a.py expectations) but eval does NOT (feeds sec_tainted_injection instead) — literal shielding is selective by signal family; candidate upstream issue
...
- 🟡 `risk_cognitive_load`: 22.4565 vs median 16.7918 (+34%)
- 🟡 `safety_bypasses`: 3 vs median 2 (+50%)
...
- **b.rs** · `let message = "if eval fails, try open"` (string): if COUNTS (branch +1) — python/js selective profile; eval/try/open inert in rust's rules. Phantom branch context triples the 2 planted mut: state_mutation 6. Ledger: string-literal-selective-shielding, state-flux-branch-weighting
...
- 🔴 `doc`: 2 vs median 1 (+100%)
- 🔴 `risk_api_exposure`: 9.28468 vs median 5.33472 (+74%)
- 🟡 `risk_cognitive_load`: 22.5164 vs median 16.7918 (+34%)
- 🟡 `risk_documentation`: 79.9223 vs median 58.3705 (+37%)
...
- **c.scm** · `(define (probe-todo plan) ...)` (code): COUNTED: hyphen is a word boundary so \bTODO\b matches inside probe-todo — planned_debt 2 (comment + identifier). Scheme joins cobol in gitgalaxy#2537's hyphenated-identifier debt leak.
...
- 🔴 `risk_cognitive_load`: 29.5468 vs median 16.7918 (+76%)
- 🟡 `globals`: 3 vs median 2 (+50%)
- 🟡 `io`: 4 vs median 3 (+33%)
- 🟡 `keyword_hits`: 169 vs median 256 (-34%)
- 🟡 `risk_documentation`: 74.608 vs median 58.3705 (+28%)
- 🟡 `safety_bypasses`: 3 vs median 2 (+50%)
...
- 🔴 `keyword_hits`: 116 vs median 256 (-55%)
- 🔴 `risk_cognitive_load`: 5.53524 vs median 16.7918 (-67%)
- 🔴 `risk_state_flux`: 0 vs median 20 (-100%)
...
- 🔴 `dependency_links`: 0 vs median 3 (-100%)
- 🔴 `risk_api_exposure`: 0.89698 vs median 5.33472 (-83%)
- 🔴 `risk_documentation`: 9.74282 vs median 58.3705 (-83%)
...
- 🔴 `risk_cognitive_load`: 5.38304 vs median 16.7918 (-68%)
- 🟡 `safety`: 3 vs median 2 (+50%)
- 🟡 `safety_bypasses`: 3 vs median 2 (+50%)
- 🟡 `state_mutation`: 9 vs median 6 (+50%)
...
- 🔴 `risk_api_exposure`: 2.0981 vs median 5.33472 (-61%)
- 🔴 `risk_cognitive_load`: 28.9992 vs median 16.7918 (+73%)
- 🟡 `keyword_hits`: 322 vs median 256 (+26%)
- 🟡 `safety`: 3 vs median 2 (+50%)
